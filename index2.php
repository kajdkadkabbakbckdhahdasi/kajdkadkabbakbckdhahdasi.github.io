  ...
  <div class="container">
    <div class="row fullscreen align-items-center justify-content-between">
      <div class="col-lg-6 col-md-6 banner-left">
        ...
        <h1 class="text-white">KABUPATEN TANAH DATAR</h1>
        <p class="text-white">
          Sistem informasi ini merupakan aplikasi pemetaan geografis tempat wisata di wilayah Tanah Datar. Aplikasi ini memuat informasi dan lokasi dari tempat wisata di Tanah Datar.
        </p>
        ...
        <div class="row align-items-center">
          ...
          <script type="text/javascript">
            function initialize() {
              ...
              var mapOptions = {
                zoom: 10.2,
                center: new google.maps.LatLng(-0.4694738,100.4427045,11),
      ...
      <div class="row d-flex justify-content-center">
        <div class="menu-content pb-70 col-lg-8">
          <div class="title text-center">
            ...
            <p>Aplikasi pemetaan geografis Wisata di kabupaten Tanah Datar ini memuat informasi dan lokasi dari Wisata ALam dan WIsata Kuliner di Tanah Datar. Pemetaan diambil dari data lokasi Google Maps dan data dari website masing-masing tempat wisata. Aplikasi ini memuat sejumlah informasi mengenai :
            </p>
          </div>
        </div>
      </div>

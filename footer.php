			...
			<footer class="footer-area section-gap">
				<div class="container">
					...
					<div class="row footer-bottom d-flex justify-content-between align-items-center">
						...
						Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved || Sistem Informasi Geografis</i> by COY || MUHAMMAD DONI</a>
</p>
						<div class="col-lg-4 col-sm-12 footer-social">
							<a href="https://facebook.com/COY170405"><i class="fa fa-facebook"></i></a>
							<a href="https://instagram.com/cooyy_17"><i class="fa fa-instagram"></i></a>
						</div>
					</div>
				</div>
			</footer>
